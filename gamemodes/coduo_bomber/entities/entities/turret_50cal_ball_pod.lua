...
if (SERVER) then
    ...
    function ENT:Initialize()
        ...
        self.Gun = ents.Create("turret_50cal_ball_gun")
        ...
        self.Base:SetModel("models/coduo/bomber/50cal_ball_base.mdl")
        self.Base:SetParent(self)
        self.Base:SetLocalPos(Vector())
    ...
    function ENT:HandleDismantle()
        ...
        self.Owner:SetPos(Vector(0, 106, -40))
        self:EmitSound("Func_Tank.BeginUse")
    ...
    function ENT:HandleRotation()
        ...
        /* TESTING */
        local posOffset = Vector(0, 0, -self.Gun.SmoothAngle.x / 30)
