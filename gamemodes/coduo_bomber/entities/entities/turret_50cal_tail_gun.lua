...
ENT.MuzzlePos = Vector(84.834793, -8.369678, -30.662678)
ENT.MuzzlePos2 = Vector(85.215958, 8.999640, -30.866264)

ENT.HorizontalCap = 45
ENT.VerticalCap = 15

ENT.UseDistance = 2000

if (SERVER) then

    function ENT:Initialize()
        self:SetModel("models/coduo/bomber/50cal_tail.mdl")
