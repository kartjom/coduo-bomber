...
ENT.PositionOffset = Vector(0, 0, 92)

ENT.MuzzlePos = Vector(104.965820, 19.191986, 6.438599)
ENT.MuzzlePos2 = Vector(104.965820, -19.191986, 6.438599)
...
if (SERVER) then
    ...
    function ENT:Initialize()
        self:SetModel("models/coduo/bomber/50cal_dorsal_gun.mdl")
